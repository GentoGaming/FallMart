...
echo Much love from Hazelight, and good luck on your project ^<3
echo.
pause
...
echo.
echo Step 2. Depot
echo This should be in the form '2020_GP3_TeamX'
echo (so for example 2020_GP3_Team5 or 2020_GP3_Team10 etc.)
echo.
...
echo However if you've made a new one already, or was assigned a new one from Allan then you can use that!
echo.
...
set build_workspace=%P4USER%_BUILD
...
echo If there are any issues ping Emil on discord! Mwah~
echo.
